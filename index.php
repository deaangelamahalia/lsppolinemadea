                                    ...
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            while ($surat = mysqli_fetch_array($query)) {
                                                ...
                                                echo "<a class='btn btn-warning btn-sm' href='unduh-arsip.php?file=" . $surat['file_surat'] . "'>Unduh</a>";
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#btn-delete', function() {
            ...
            console.log(id);
            Swal.fire({
                title: 'Apakah Kamu Yakin Menghapus Arsip Surat Ini',
                showDenyButton: true,
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        data: "id=" + id,
                        url: '/ujikompetensi/hapus-arsip.php',
                    ...
                    Swal.fire('Arsip Surat Tidak jadi di hapus', '', 'info')
                }
            })
        });
    });
